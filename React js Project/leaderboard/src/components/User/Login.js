...
export default function Login(){
    return(
        <div>
            {/* user login card */}
            <LoginCard
              admintokenoruser = "admintoken"
              useroradmintoken = "usertoken"
              dbfolder = "Users"
              redirectlink = {"/home"}
              adminoruseralreadyloggedmsg = "!! PLease SignOut From Admin Login"
              isuserlogin = {true}
            />
        </div>
    )
...
//                 insertValues();
//             }
//             sessionStorage.setItem("usertoken", "jasfndsdubczjxcnnx");
//             setloggedIn(true);
//         }).catch(function (error) {
//             setinvalidotp(true);
//             console.log(error.message);
...
//                                             <div style={{ display: (checkadmin ? "block" : "none"), color: "red", fontSize: "13px" }}>
//                                                 !! Please SignOut from Admin Login</div>
...
//                                             <div>
//                                               {true ?
//                                             <Form.Group id="name" style={{ opacity: (s1 ? 1 : 0.1) }}>
//                                                 <Form.Label >Your Instructor Id</Form.Label>
//                                                 <Form.Control type="text" onChange={(e) => { localStorage.setItem("adminid",e.target.value); setinvalid(false); }} required />
//                                             </Form.Group>
//                                             : null
//                                             }
//                                             </div>
